...
<div class="left-content">
	   <div class="mother-grid-inner">
		...
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<c:url value="/Admin/Home" />">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
                                ...
                                <div class="card-body p-b-20">
                                    <div class="list-group">
                                        <a class="list-group-item media" href="">
                                             <div class="pull-left">
                                                <img class="lg-item-img" src="<c:url value="/resources/admin_images/in1.jpg" />" alt="">
                                            </div>
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="<c:url value="/resources/admin_images/in2.jpg" />" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="<c:url value="/resources/admin_images/in3.jpg" />" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="<c:url value="/resources/admin_images/in4.jpg" />" alt="">
                                            </div>
                                            <div class="media-body">
                                            	<div class="pull-left">
...
<!-- Bootstrap Core JavaScript -->
   ...
   <!-- /Bootstrap Core JavaScript -->	      
<!-- morris JavaScript -->	
<script src="<c:url value="/resources/admin_js/raphael-min.js" />"></script>
<script src="<c:url value="/resources/admin_js/morris.js" />"></script>
<script>
	$(document).ready(function() {
