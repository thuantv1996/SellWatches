			...
			<div class="mother-grid-inner">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.html">Home</a><i
						class="fa fa-angle-right"></i>Add promotion <i class="fa fa-angle-right"></i>
						</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
					<div class="grid-form1">
						<h2 id="forms-example" class="">Add promotion</h2>
						...
						<form:form method="POST" action="/SellWatches/admin/promotion/add"
